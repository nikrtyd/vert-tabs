...
const getThemeCSS = async function getCurrentBrowserThemeAndApplyNewCSS() {
  ...
  // If theme.colors, theme.images & theme.properties are null, assume that default theme is used. Returning.
...
const applyCSS = function (css, element) {

}

// Get theme on first sidebar activation
applyCSS(getThemeCSS());
